const NewsLatter = () => {
  return (
    <section className="flex items-center bg-gray-100 font-poppins dark:bg-gray-800 my-8">
      <div className="justify-center flex-1 mx-auto ">
        <div
          className="relative p-4  bg-white bg-bottom bg-no-repeat bg-cover rounded-md shadow md:p-10 dark:bg-gray-900"
          style={{
            minHeight: '580px',
          ...
          <div className="absolute top-0 bottom-0 left-0 right-0 flex items-center ">
            <div className="max-w-3xl px-4 mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center ">
                ...
                />
                <button className="w-full px-6 py-4 text-sm font-semibold text-gray-100 bg-blue-500 rounded md:w-auto md:ml-2 dark:bg-blue-400 dark:hover:bg-blue-500 hover:bg-blue-600">
                  Subscribe
                </button>
              </div>
            </div>
