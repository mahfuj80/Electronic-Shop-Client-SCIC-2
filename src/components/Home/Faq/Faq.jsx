const Faq = () => {
  ...
  return (
    <div>
      <section className="py-10 bg-gray-50 sm:py-16 lg:py-16 my-8">
            ...
            <div className="transition-all duration-200 bg-white border border-gray-200 shadow-lg cursor-pointer hover:bg-gray-50">
              ...
              >
                <p>
                  ...
                  plans. You can choose the one that suits your needs and
                  budget.
                </p>
              </div>
            </div>
